      ...
      >
        ...
        {success ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 mt-2 text-sm">{t('successDesc')}</p>
          ...
          <>
            ...
            <form ref={formRef} action={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-gray-600 mb-1">{t('nom')} *</label>
                  <input name="nom" required className={fieldClass} />
                </div>
                <div>
                  <label className="block text-xs font-medium text-gray-600 mb-1">{t('prenom')} *</label>
                  <input name="prenom" required className={fieldClass} />
                </div>
              </div>
              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1">{t('telephone')} *</label>
